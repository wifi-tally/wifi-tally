describe("Settings parser", function()
    ...
    insulate("stageBrightness", function()
        require "src.my-settings"
        it("has a default", function()
            assert.is_same( 100, MySettings.stageBrightness())
        end)
        it("can be read and written", function()
            MySettings.setStageBrightness(42)
            assert.is_same( 42, MySettings.stageBrightness())
        end)
        it("can not exceed valid values", function()
            MySettings.setStageBrightness(-100)
            assert.is_same( 0, MySettings.stageBrightness())
            MySettings.setStageBrightness(0)
            assert.is_same( 0, MySettings.stageBrightness())
            MySettings.setStageBrightness(42)
            assert.is_same( 42, MySettings.stageBrightness())
            MySettings.setStageBrightness(100)
            assert.is_same( 100, MySettings.stageBrightness())
            MySettings.setStageBrightness(101)
            assert.is_same( 100, MySettings.stageBrightness())
        end)
    end)

    insulate("operatorBrightness", function()
        require "src.my-settings"
        it("has a default", function()
            assert.is_same( 100, MySettings.operatorBrightness())
        end)
        it("can be read and written", function()
            MySettings.setOperatorBrightness(42)
            assert.is_same( 42, MySettings.operatorBrightness())
        end)
        it("can not exceed valid values", function()
            MySettings.setOperatorBrightness(-100)
            assert.is_same( 20, MySettings.operatorBrightness())
            MySettings.setOperatorBrightness(0)
            assert.is_same( 20, MySettings.operatorBrightness())
            MySettings.setOperatorBrightness(20)
            assert.is_same( 20, MySettings.operatorBrightness())
            MySettings.setOperatorBrightness(42)
            assert.is_same( 42, MySettings.operatorBrightness())
            MySettings.setOperatorBrightness(100)
            assert.is_same( 100, MySettings.operatorBrightness())
            MySettings.setOperatorBrightness(101)
            assert.is_same( 100, MySettings.operatorBrightness())
        end)
    end)
